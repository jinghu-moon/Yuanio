...
import sy.yuanio.app.data.InteractionDispatchResult
import sy.yuanio.app.data.WorkflowSnapshotStore
import sy.yuanio.app.data.sendOrQueueApprovalResponse
...
fun ApprovalInboxScreen(
    ...
    fun handleMany(approvalIds: List<String>, approved: Boolean) {
        ...
        val successApprovals = mutableListOf<sy.yuanio.app.data.WorkflowApprovalSnapshot>()
