...
import sy.yuanio.app.BuildConfig
import sy.yuanio.app.R
import sy.yuanio.app.data.ComposerDraftStore
...
import sy.yuanio.app.data.OnDeviceTranslationEngine
import sy.yuanio.app.data.PromptDetector
import sy.yuanio.app.data.TemplateStore
import sy.yuanio.app.data.TranslateDirection
import sy.yuanio.app.data.UriFileUtils
import sy.yuanio.app.data.VoiceInputPrefs
import sy.yuanio.app.ui.chat.AgentStatusBar
import sy.yuanio.app.ui.chat.ChatDialogs
import sy.yuanio.app.ui.chat.ChatInputBar
import sy.yuanio.app.ui.chat.InputBarState
import sy.yuanio.app.ui.chat.ChatMessageList
import sy.yuanio.app.ui.chat.ChatTopBar
import sy.yuanio.app.ui.chat.ConnectionBanner
import sy.yuanio.app.ui.chat.MessageListCallbacks
import sy.yuanio.app.ui.chat.QuickReplyRow
import sy.yuanio.app.ui.chat.TemplateChipRow
import sy.yuanio.app.ui.component.ApprovalCard
import sy.yuanio.app.ui.component.DiffPanel
import sy.yuanio.app.ui.component.SplitPaneLayout
import sy.yuanio.app.ui.component.DiffPanelItem
import sy.yuanio.app.ui.component.TerminalView
import sy.yuanio.app.ui.common.resolve
...
fun ChatScreen(
    ...
    LaunchedEffect(requestedTaskId, uiState.connState, taskDetailDispatched) {
        ...
        if (uiState.connState != sy.yuanio.app.data.ConnectionState.CONNECTED) return@LaunchedEffect
    ...
    Scaffold(
        ...
        Column(
            ...
            ChatInputBar(
                ...
                showTranslate = BuildConfig.FEATURE_TRANSLATION,
                onOpenFiles = {
                    if (quickUploadState.active) {
                        uploadTransientMessage = chatUploadInProgressMessage
                    } else {
...
private fun ConnectionRecoveryActions(
    connState: sy.yuanio.app.data.ConnectionState,
    ...
    if (connState == sy.yuanio.app.data.ConnectionState.CONNECTED) return
    Surface(
...
private fun buildScenarioQuickReplies(
    ...
    if (connState != sy.yuanio.app.data.ConnectionState.CONNECTED) {
        return listOf(
