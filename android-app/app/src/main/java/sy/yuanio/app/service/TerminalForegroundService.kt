...
import sy.yuanio.app.MainActivity
...
class TerminalForegroundService : Service() {
    ...
    companion object {
        const val ACTION_START = "sy.yuanio.app.terminal.START"
        const val ACTION_STOP = "sy.yuanio.app.terminal.STOP"
