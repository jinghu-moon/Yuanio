...
internal class DefaultSessionGateway(
    ...
    override fun registerPushToken(token: String) {
        activeTransport?.registerPushToken(token)
    }
...
internal class RelayGatewayTransport(
    ...
    override fun registerPushToken(token: String) = client.registerFcmToken(token)
...
internal class LocalGatewayTransport(
    ...
    override fun registerPushToken(token: String) = Unit
